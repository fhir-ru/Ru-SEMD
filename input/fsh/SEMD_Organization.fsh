...
Parent: Organization
Title: "Организация"
Description: "Профиль Organization для СЭМД. Определен порядок использования ИНН, ОГРН, ФРМО, Медицинской лицензии, ОКПО, ОКАТО в качестве идентификаторов. TODO: исправить: ОКАТО - не идентификатор!"
